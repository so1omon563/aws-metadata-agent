...
- [Shell prompt and status integrations](shell-prompts.md) — display, scope,
  label, or warn on the exact live active profile in Starship, zsh, Bash, fish,
  tmux, editors, and status bars.
